function ObjSub = fieldsubject()
    ...
    uicontrol(F, 'Style','text', 'Position',[20,h+90,200,20], 'String', 'Species (mouse, monkey, human)');
    CntrSpec = uicontrol(F, 'Style','edit', 'Position',[220, h+90, 120,20], 'Callback', @Cb );
    uicontrol(F, 'Style','text', 'Position',[20,h+60,200,20], 'String', 'Sex (M, F, U)');
    CntrSex = uicontrol(F, 'Style','edit', 'Position',[220, h+60, 120,20], 'Callback', @Cb );
  ...
  function Cb(src, ~)
    switch src  
        ...
        case CntrSpec
            ObjSub.species = src.String;
        case CntrSex
            ObjSub.sex = src.String;
        case CntrGeno
